...
export default function ProfileEditor({ user, profile, onUploadSuccess, onSuccess }) {
    ...
    return (
        <div className="space-y-8 max-h-[70vh] overflow-y-auto pr-2">
            ...
            {/* --- SEÇÃO 3: INFORMAÇÕES E REDES SOCIAIS --- */}
            <form onSubmit={handleProfileUpdate} className="space-y-4">
                <h4 className="font-bold text-white text-lg border-b-2 border-zinc-700 w-full text-center pb-2">Editar Informações e Redes Sociais</h4>
                <div>
